                ...
                <div className="py-4 container-fluid">
                    <div className="row d-flex justify-content-start align-items-start py-3 mx-3 h-100 about-container rounded">
                        ...
                        <div className="col-lg-7 col-md-7 cl-sm-12 col-12">
                            <img className="img-fluid p-2" style={{ width: '620px', height: '420px' }} src="https://images.unsplash.com/photo-1563990308267-cd6d3cc09318?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="" />
                        </div>
                    </div>
                </div>
            </section>
