...
const WhyChooseUs = () => {
    ...
    return (
        <section className="">
            <div className="row d-flex justify-content-start align-items-start h-100 whyChooseUs-container rounded">
                <div className="col-lg-7 col-md-7 cl-sm-12 col-12">
                    <img className="img-fluid p-2 mt-5" style={{ width: '550px', height: '320px' }} src="https://images.unsplash.com/photo-1549216963-72c1712c1196?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=869&q=80" alt="" />
                </div>
